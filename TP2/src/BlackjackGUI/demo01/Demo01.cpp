...
void Demo01::componentsInitialization() {
	...
	this->m_FPSOn->addMouseClickHandler([&](const TGUIWSFML::Event::MouseEvent& me) 
		{ 
	...
	this->m_labelHello->addMouseClickHandler([this](const TGUIWSFML::Event::MouseEvent& me)
		{
			this->m_labelHello->text("");
			bool labelClicked = true;
			//sf::Event dummyEvent;
			//std::string key = getPressedKey(dummyEvent);
			//this->m_labelHello->text(key);
		});
	...
	this->m_toogleFPSLimit->addMouseClickHandler([&](const TGUIWSFML::Event::MouseEvent& me) 
		{
